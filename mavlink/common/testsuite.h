...
static void mavlink_test_uom_atmospheric_data(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_uom_atmospheric_data_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0,963498712,963498920,963499128,963499336,963499544,325.0,353.0,381.0,409.0,437.0,465.0,493.0,20979,21083,21187,21291,21395
    };
	mavlink_uom_atmospheric_data_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.roll = packet_in.roll;
        	packet1.pitch = packet_in.pitch;
        	packet1.yaw = packet_in.yaw;
        	...
        	packet1.press_abs = packet_in.press_abs;
        	packet1.press_diff = packet_in.press_diff;
        	packet1.OP1 = packet_in.OP1;
        	packet1.OP2 = packet_in.OP2;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_uom_atmospheric_data_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_uom_atmospheric_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_uom_atmospheric_data_pack(system_id, component_id, &msg , packet1.roll , packet1.pitch , packet1.yaw , packet1.rollspeed , packet1.pitchspeed , packet1.yawspeed , packet1.time_boot_ms , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.vx , packet1.vy , packet1.vz , packet1.airspeed , packet1.groundspeed , packet1.heading , packet1.press_abs , packet1.press_diff , packet1.temperature , packet1.OP1 , packet1.OP2 , packet1.CO );
	mavlink_msg_uom_atmospheric_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_uom_atmospheric_data_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.roll , packet1.pitch , packet1.yaw , packet1.rollspeed , packet1.pitchspeed , packet1.yawspeed , packet1.time_boot_ms , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.vx , packet1.vy , packet1.vz , packet1.airspeed , packet1.groundspeed , packet1.heading , packet1.press_abs , packet1.press_diff , packet1.temperature , packet1.OP1 , packet1.OP2 , packet1.CO );
	mavlink_msg_uom_atmospheric_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_uom_atmospheric_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_uom_atmospheric_data_send(MAVLINK_COMM_1 , packet1.roll , packet1.pitch , packet1.yaw , packet1.rollspeed , packet1.pitchspeed , packet1.yawspeed , packet1.time_boot_ms , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.vx , packet1.vy , packet1.vz , packet1.airspeed , packet1.groundspeed , packet1.heading , packet1.press_abs , packet1.press_diff , packet1.temperature , packet1.OP1 , packet1.OP2 , packet1.CO );
	mavlink_msg_uom_atmospheric_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_uom_atmospheric_data(system_id, component_id, last_msg);
